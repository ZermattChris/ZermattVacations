...
<html>
    <head>
		...
		<title>Holiday Apartment Guestbook :: Zermatt Vacation Apartments &amp; Holiday Flats</title>
	...
	<body>
		...
		<?php include_once( $_SERVER["DOCUMENT_ROOT"] . "/includes/menus/guestbook-en.php" ); ?>
		...
		<div id="headingBox">
        	...
        	<span class="underline"><h1><span class="caps">G</span>uestbook — Let us know your opinion</h1></span>
			<span class="languageMenu">
				english :: 
				<a href="add-guestbook-entry-d.php" title="Change this site's language to German">deutsch</a>
			</span>
		</div>
		...
		<div id="contents_box">
			<div id="contents">
				...
				<p>
					Would love to hear your thoughts and comments about your stay with us here in Zermatt
					and general feedback on our website ZermattVacations.com.
				</p>
				
				<?php 
					// Display Form entry errors bubble
					if ( isset( $_SESSION['errorsHtml'] ) && $_SESSION['errorsHtml'] !== '' ) {
						echo "<h3 class='formEntryErrors'>Whoops! Forgot something...</h3>";
      ...
      <td>
        <div align="center">
			...
			-->
              <tr bgcolor="#EDEEE8"> 
                <td width="28%"> 
                  <div align="right"><font face="verdana" size="2">*Country : </font></div>
                </td>
                <td width="72%"> 
                <select name="country">
				<?php 
              ...
              <tr bgcolor="#EDEEE8"> 
                <td valign="top" width="28%"> 
                  <div align="right"><font face="verdana" size="2">*Comment : </font></div>
                </td>
                <td width="72%">

                    <textarea name="comment" cols="45" rows="8" wrap="virtual"><?php echo $_SESSION['comment']; ?></textarea>

    <br><font size="1" face="verdana">* Required field</font>
                </td>
              </tr>
				<tr bgcolor="#E4E4E4"> 
					<td colspan="2"> 
						<div align="center">
							...
							<p>*Please enter the following text into the field below</p>
							<div style="height:10px;"></div>
							...
							<br />
							<a href="#" onclick="document.getElementById('captcha').src = '/securimage/securimage_show.php?' + Math.random(); return false">Show a different Image <img border="0" align="bottom" onclick="this.blur()" alt="Reload Image" src="/securimage/images/refresh.gif" /></a>
				...
				<div class="standard_button" style="float:clear; margin-top:20px; margin-left:auto; margin-right:auto;">
					<a href="/guestbook/index.php" >Back</a>
				</div>
