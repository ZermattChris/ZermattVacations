...
<html>
    <head>
        ...
        <title>Guestbook for Zermatt Vacation Apartments &amp; Holiday Flats</title>
	...
	<body>
		...
		<div id="contents_box">
			<div id="contents">
				...
				<p>
					Tell us about your stay in a Zermatt Vacations holiday apartment, 
					and about your stay in Zermatt. This guestbook is also a great 
					place to read what others have to say about both Zermatt Vacations 
					apartments, and their holidays in Zermatt. 
				</p>
				
				<div style="width:100%; height:15px;"></div>
				
				<h2>Let us know your opinion — add a new entry to the ZermattVacations.com Guestbook!</h2>
				<div class="standard_button" style="float:clear; margin-top:20px; margin-bottom:20px; margin-left:auto; margin-right:auto;">
					<a href="/guestbook/add-guestbook-entry.php">Add an Entry</a>
				</div>
