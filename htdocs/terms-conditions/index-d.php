...
<html>
    <head>
        ...
        <title>Kontakt mit Zermatt Vacations :: Zermatt Vacations</title>
	...
	<body>
		...
		<?php include_once( $_SERVER["DOCUMENT_ROOT"] . "/includes/menus/detail-de.php" ); ?>
		...
		<div id="headingBox">
        	...
        	<span class="underline"><h1><span class="caps">K</span>ontakt mit Zermatt Vacations </h1></span>
			<span class="languageMenu">
				<a href="contact.php" title="Change this site's language to English">english</a>
				:: deutsch
			</span>
		</div>
		...
		<div id="contents_box">
			<div id="contents">
				...
				<h2 class="emailLink"><a href="mailto:info@zermattvacations.com?subject=Contact Request from the Zermatt Vacations web site" title="�ffnen eine E-mail zu Zermatt Vacations">info@zermattvacations.com</a></h2>
				<br/>
