...
<html>
    <head>
        ...
        <title>Zermatt Vacations :: Vielen Dank für Ihre Anfrage!</title>
	...
	<body>
		...
		<div id="headingBox">
        	...
        	<span class="underline"><h1><span class="caps">V</span>ielen Dank für Ihre Anfrage!</h1></span>
			<span class="languageMenu">
				<a href="thanks.php" title="Change this site's language to English">english</a>
				:: deutsch
			</span>
		</div>
		...
		<div id="contents_box">
			<div id="contents">
				...
				<p>
					Wir haben Ihre Anfrage erhalten und werden Ihnen bald antworten. 
				</p>
